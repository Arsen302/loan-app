...
function SecondLoan({ totalAmount, setTotalAmount }) {
  ...
  const secondLoans = loans
    .filter((loan) => loan.id === "5")
    .map((loan) => (
      <div key={loan}>
        ...
        <p key={loan.term_remaining}>Loan ends in: 19 days</p>
        <p key={loan.amount}>
          Investment amount:{" "}
